        ...
        <div class="card bg-light mb-3" style="max-width: 46rem;box-shadow: 2px 2px 2px 2px rgba(0.6, 0.6, 0.6, 0.6);">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input <%if (email != null){%>value="<%=email%>"<%}%> name="email" type="email" class="form-control"
                ...
                <div class="form-group">
                    ...
                    <input <%if (fullName != null){%>value="<%=fullName%>" <%}%> name="fullName" type="text"
                           class="form-control" id="exampleInputEmail3" aria-describedby="emailHelp"
